...
#define KC_FLXP LGUI(KC_E)
 ...
 /*
LGUI_T(KC_A), LALT_T(KC_S), LSFT_T(KC_A), LCTL_T(KC_S),
RCTL_T(KC_J), RSFT_T(KC_K), LALT_T(KC_L), RGUI_T(KC_SCLN)
*/

#define HOME_A LSFT_T(KC_A)
#define HOME_S LGUI_T(KC_S)
#define HOME_D LT(_FN3, KC_D)
#define HOME_F LCTL_T(KC_F)

#define HOME_J RCTL_T(KC_J)
#define HOME_K LT(_FN3, KC_K)
#define HOME_L RGUI_T(KC_L)
#define HOME_Ö RSFT_T(KC_SCLN)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_iso_68(
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,  KC_EQL,   KC_BSPC,          KC_MUTE,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC,  KC_RBRC,                    KC_DEL,
        KC_CAPS, HOME_A,  HOME_S,  HOME_D,  HOME_F,  KC_G,    KC_H,    HOME_J,  HOME_K,  HOME_L,  HOME_Ö,  KC_QUOT,  KC_NUHS,  KC_ENT,           KC_HOME,
        KC_LSFT, KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,            KC_RSFT, KC_UP,
